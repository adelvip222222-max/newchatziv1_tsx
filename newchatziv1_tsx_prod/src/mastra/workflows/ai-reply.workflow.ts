...
const loadConversationStep = createStep({
  ...
  execute: async ({ inputData }) => {
    ...
    if (!isValidObjectId(inputData.tenantId) || !isValidObjectId(inputData.botId)) {
    ...
    const conversation =
      inputData.conversationId && isValidObjectId(inputData.conversationId)
    ...
    const userMessage = sourceMessageId && isValidObjectId(String(sourceMessageId))
