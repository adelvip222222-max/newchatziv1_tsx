...
const workerEnv = {
  ...
  CORE_ROUTING_WORKER_CONCURRENCY: envOr('CORE_ROUTING_WORKER_CONCURRENCY', '6'),
  ...
  AI_FAST_RESPONDER_ENABLED: envOr('AI_FAST_RESPONDER_ENABLED', 'true'),
  AI_FAST_RESPONDER_MAX_CHARS: envOr('AI_FAST_RESPONDER_MAX_CHARS', '240'),
  AI_FAST_RESPONDER_MIN_CONFIDENCE: envOr('AI_FAST_RESPONDER_MIN_CONFIDENCE', '75'),
  AI_FAST_RESPONDER_TEMPERATURE: envOr('AI_FAST_RESPONDER_TEMPERATURE', '0.1'),
